  ...
  <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
        ...
        <div class="bb ze ki xn 2xl:ud-px-0">
          <div class="tc _o">
            <div class="animate_left jn/2">
              ...
              <h1 class="fk vj zp or kk wm wb">Add New Mentor</h1>
    ...
    <form method="POST" action="{{ route('mentors.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="photo_url" name="photo_url" placeholder="images/mentor/10.jpg"required>
        </div>
