    ...
    <main>
      ...
      <section class="gj do ir hj sp jr i pg">
        ...
        <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
          ...
          <img src="{{ asset($module->img_url) }}" alt="Woman" class="h q r ua" />
        </div>
        ...
        <div class="bb ze ki xn 2xl:ud-px-0">
          <div class="tc _o">
            <div class="animate_left jn/2">
              <h1 class="fk vj zp or kk wm wb">{{ $module->title }}</h1>
              <h4 class="fk vj zp or kk wm wb">{{ $module->content }}</h4>
              <p class="fq">
              Mentors for this Module</p>
              <ul>
            @foreach($module->mentors as $mentor)
                <li>{{ $mentor->name }} {{ $mentor->surname }}</li>
            @endforeach
        </ul>
              

              <div class="tc tf yo zf mb">
                <a href="{{ route('modules.index') }}" class="ek jk lk gh gi hi rg ml il vc _d _l">Back to previous page</a>
              </div>
            </div>
          </div>
        </div>
